...
```
.
├── benchmark.py        # Script principal d'orchestration des benchmarks
├── locustfile.py       # Définition des tâches Locust (test de charge)
├── plot_results.py     # Génération des graphiques barplot
├── requirements.txt    # Dépendances Python
├── out/
│   ├── conc.csv        # Résultats expérience concurrence
│   ├── conc.png        # Barplot concurrence
│   ├── fanout.csv      # Résultats expérience fanout
│   └── fanout.png      # Barplot fanout
└── README.md
```
...
python benchmark.py seed --app-url https://tp-tiny-insta-enzo-sam.ew.r.appspot.com

# 2. Lancer l'expérience concurrence
python benchmark.py conc --app-url https://tp-tiny-insta-enzo-sam.ew.r.appspot.com

# 3. Lancer l'expérience fanout
python benchmark.py fanout --app-url https://tp-tiny-insta-enzo-sam.ew.r.appspot.com
